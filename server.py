    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            ...
            "You are in the room with the green statue.",
            "You are in the room with the blue ceiling.",
            "You are in the room with the black canvas painting.",
        ][room_number]
    ...
    def move(self, argument):
        ...
        * "west"
        ...
        # return to room 0...
        if self.room == 1 and argument.lower() == "east" or \
           self.room == 2 and argument.lower() == "west" or \
           self.room == 3 and argument.lower() == "south":
            self.room = 0
